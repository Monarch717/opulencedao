              ...
              <div className="grid gap-12 sm:grid-cols-2 sm:gap-x-6 md:gap-y-8 items-start">
                ...
                <article className="flex flex-col h-full">
                  ...
                  <footer className="flex items-center mt-4">
                    <a href="#0">
                      <img className="rounded-full shrink-0 mr-3" src={require('../images/news-author-03.jpg').default} width="32" height="32" alt="Author 03" />
                    </a>
                ...
                <article className="flex flex-col h-full">
                  ...
                  <footer className="flex items-center mt-4">
                    <a href="#0">
                      <img className="rounded-full shrink-0 mr-3" src={require('../images/news-author-06.jpg').default} width="32" height="32" alt="Author 06" />
                    </a>
                    <div className="text-sm text-gray-500">
                ...
                <article className="flex flex-col h-full">
                  ...
                  <footer className="flex items-center mt-4">
                    <a href="#0">
                      <img className="rounded-full shrink-0 mr-3" src={require('../images/news-author-01.jpg').default} width="32" height="32" alt="Author 01" />
                    </a>
                    <div className="text-sm text-gray-500">
                ...
                <article className="flex flex-col h-full">
                  ...
                  <footer className="flex items-center mt-4">
                    <a href="#0">
                      <img className="rounded-full shrink-0 mr-3" src={require('../images/news-author-04.jpg').default} width="32" height="32" alt="Author 04" />
                    </a>
                    <div className="text-sm text-gray-500">
                ...
                <article className="flex flex-col h-full">
                  ...
                  <footer className="flex items-center mt-4">
                    <a href="#0">
                      <img className="rounded-full shrink-0 mr-3" src={require('../images/news-author-05.jpg').default} width="32" height="32" alt="Author 05" />
                    </a>
                    <div className="text-sm text-gray-500">
