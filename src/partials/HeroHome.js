            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 pt-32 pb-12 md:pt-32 mb-3">
                <div className="pt-32 pb-12 md:pt-40 md:pb-20">
                    <div className="max-w-4xl mx-auto text-center">
                        <h2 className="h2 font-red-hat-display mb-4" data-aos="fade-down">The World's First <span
                            className="gradient">Multi-Chain</span> DeFi Yield Processing Node.</h2>
                        ...
                        <div class="mt-8 aos-init aos-animate" data-aos="fade-down" data-aos-delay="300">
                            ...
                            <button onClick={() => onCreateNode()}
                                ...
                                <svg class="fill-current text-white mr-2 mt-0.5 flex-shrink-0" width="20" height="20">
